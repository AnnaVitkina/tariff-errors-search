...
RULE_TITLES: dict[str, str] = {
    ...
    "CHARGE_CODE_CHANGED": "Charge codes changed",
    "SERVICE_CODE_CHANGED": "Service codes changed",
    "POSTAL_CODE_CHANGED": "Postal / zone codes changed",
    "REMARK_CHANGED": "Remark / comments text changed",
